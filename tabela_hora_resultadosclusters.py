# -*- coding: utf-8 -*-
"""
Created on Mon Sep 13 20:05:45 2021

@author: elisaaraujo
"""


from leitura_datasets import df_medias_hora_6meses_clusters_domesticos
from leitura_datasets import df_medias_mes_6meses_clusters_domesticos
from leitura_datasets import df_medias_dia_6meses_clusters_domesticos
import seaborn as sns
import matplotlib.pyplot as plt



df_clusters_hora=df_medias_hora_6meses_clusters_domesticos.loc[:,['Local' ,'Clusters']]
df_clusters_hora.set_index('Local',inplace=True)
df_clusters_hora=df_clusters_hora.rename(columns={'Clusters':'Clusters_hora'})

df_clusters_mes=df_medias_mes_6meses_clusters_domesticos.loc[:,['Local' ,'Clusters']]
df_clusters_mes.set_index('Local',inplace=True)
df_clusters_mes=df_clusters_mes.rename(columns={'Clusters':'Clusters_mes'})

df_clusters_dia=df_medias_dia_6meses_clusters_domesticos.loc[:,['Local' ,'Clusters']]
...
df_clusters_hora_dia_mes.to_feather('df_clusters_hora_dia_mes')
